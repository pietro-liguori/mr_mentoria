...
public class CustoController implements IController<Custo, CustoDTO> {
	...
	public ResponseEntity<Custo> findById(@PathVariable Object id) {
	...
	@PostMapping
	@PreAuthorize("hasAnyRole('ADMIN', 'MENTOR')")
	public ResponseEntity<Custo> insert(@RequestBody @Valid CustoDTO dto) {
	...
	@PutMapping("/{id}")
	@PreAuthorize("hasAnyRole('ADMIN', 'MENTOR')")
	public ResponseEntity<Custo> update(@RequestBody @Valid CustoDTO dto, @PathVariable Object id) {
