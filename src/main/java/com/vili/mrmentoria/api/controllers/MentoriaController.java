...
public class MentoriaController implements IController<Mentoria, MentoriaDTO> {
	...
	public ResponseEntity<Mentoria> findById(Object id) {
	...
	@PostMapping
	@PreAuthorize("hasAnyRole('ADMIN', 'MENTOR')")
	public ResponseEntity<Mentoria> insert(MentoriaDTO dto) {
	...
	@PutMapping("/{id}")
	@PreAuthorize("hasAnyRole('ADMIN', 'MENTOR')")
	public ResponseEntity<Mentoria> update(MentoriaDTO dto, Object id) {
