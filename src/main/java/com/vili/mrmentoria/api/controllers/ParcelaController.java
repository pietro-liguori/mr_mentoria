...
public class ParcelaController implements IController<Parcela, ParcelaDTO> {
	...
	public ResponseEntity<Parcela> findById(Object id) {
	...
	@PostMapping
	@PreAuthorize("hasAnyRole('ADMIN', 'MENTOR')")
	public ResponseEntity<Parcela> insert(ParcelaDTO dto) {
	...
	@PutMapping("/{id}")
	@PreAuthorize("hasAnyRole('ADMIN', 'MENTOR')")
	public ResponseEntity<Parcela> update(ParcelaDTO dto, Object id) {
