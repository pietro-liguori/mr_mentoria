...
@JsonPropertyOrder({ "id", "descricao", "valor", "data", "entrada", "dataEntrada", "numeroDeParcelas", "parcelas", "metodo", "tipo", "status", "observacao", "descontos", "mentorias" })
public abstract class Pagamento implements IEntity {
	...
	@ManyToMany
	@JoinTable(name = "pagamentos_mentorias", joinColumns = @JoinColumn(name = "pagamento_id"), inverseJoinColumns = @JoinColumn(name = "mentoria_id"))
	...
	public Pagamento(Long id, String descricao, Double valor, String observacao, MetodoPagamento metodo, TipoPagamento tipo, StatusPagamento status, Mentoria... mentorias) {
		init();
		setId(id);
		...
		setTipo(tipo);
		setStatus(status);
		setMentorias(Stream.of(mentorias).collect(Collectors.toSet()));
	}
	...
	public void setMetodo(MetodoPagamento metodo) {
		this.metodo = metodo == null ? null : metodo.getCode();
	}
